...
with DAG(
    ...
    start >> [product_order, product_order_items. product_order_items_sku, product, sku, user] >> 
    [load_product_order_to_bigquery
    , load_product_order_items_to_bigquery
    , load_product_order_items_sku_to_bigquery
    , load_product_to_bigquery
    , load_sku_to_bigquery
    , load_user_to_bigquery] >> end
